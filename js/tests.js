/*
 * Add future Manobhaav tests inside this object.
 * Give every test a unique ID. The same frontend and Google Apps Script
 * will automatically handle the new test and create its own Sheet tab.
 */
const tests = {
  "gse-10": {
    ...
    ranges: [
      {
        min: 10,
        max: 20,
        label: "Lower self-efficacy",
        description: "Your score falls in the lower self-efficacy range."
      },
      {
        min: 21,
        max: 30,
        label: "Moderate self-efficacy",
        description: "Your score falls in the moderate self-efficacy range."
      },
      {
        min: 31,
        max: 40,
